            ...
            public void onClick(View v) {
                try {
                    ...
                    if (inputInfo.isEmpty()) {
                        Toast.makeText(MoneyActivity.this, R.string.input_empty_error, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MoneyActivity.this, inputMoney + " " + inputInfo, Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(MoneyActivity.this, R.string.input_money_error, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
